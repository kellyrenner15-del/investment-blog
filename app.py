...
BLOG_POSTS = [
    {
        ...
        <h2>投資を始める前に知るべき</h2>
        <h2>基礎知識</h2>
        <li><strong>株式投資は、将来に向けた資産形成の有力な手段のひとつです。<li><strong>
       <li><strong>ただし、始める前に基本的な考え方や大切なポイントを押さえておくことが重要です。<li>

        <h3>1. 投資の基本ポイント</h3>
        <li><strong>投資で安定した成果を目指すには、明確な目的とリスク管理の考え方が大切です。以下のポイントを意識しておきましょう。<li>
        <ul>
            <li><strong>財務目標を明確にする：老後資金、住宅購入、教育資金など、何のために資産を増やしたいのかを整理しましょう。</li>
            <li><strong>リスク許容度を把握する：ご自身がどの程度の値動きまで受け入れられるかを知ることが大切です。</li>
            <li><strong>投資期間を考える：短期か長期かによって、取るべき戦略は大きく変わります。</li>
            <li><strong>投資金額を決める：無理のない余裕資金の範囲で始めることが基本です。</li>
        </ul>

        <h3>2.  リスク管理の重要性</h3>
        <p>どのような投資にも、一定のリスクは伴います。</p>
        <p>大切なのは、リスクを避けることではなく、正しく理解し、適切に管理することです。</p>
        </p>分散投資や資産配分の見直しは、安定した運用を目指すうえで欠かせない考え方です。<p>
        <h3>3. 始める前に準備しておきたいこと</h3>
        <p>投資を始める前に、以下の準備をしておくと安心です。</p>
        <ul>
            <li>証券口座の開設</li>
            <li>投資に使う資金の確認</li>
            <li>基礎知識の習得</li>
        ...
        <h3>4. はじめての投資のコツ</h3>
        <p>最初は少額からスタートするのがおすすめです。</p>
        <p>相場の動きを見ながら、少しずつ知識と経験を積み重ねていくことが、長く続けるための大切なポイントです。</p>
        ''',
        'author': '堀江貴文',
    ...
    },
    {
        ...
        ''',
        'author': '堀江貴文',
        'author_credentials': '行動経済学の専門家心理学の観点から投資を研究。',
        'date': '2026 2/20',
        'category': '投資戦略',
        'tags': ['心理学', '投資', 'バイアス'],
    ...
    },
    {
        ...
        <h3>テクニカル分析の限界</h3>
        <p>テクニカル分析は参考情報です。100%の精度はなく、ファンダメンタル分析併用することが重要です。</p>
        ''',
        'author': '堀江貴文',
    ...
    },
    {
        ...
        'content': '''
        <h2>IPOとは</h2>
        <p>IPO（Initial Public Offering）はこれまで非公開だった企業が初めて株式を公開する際の新規公開株式のことです。</p>
